...
void globalOnHomieEvent(const HomieEvent& event) {
    ...
    switch(event.type) {
        ...
        // Do whatever you want when OTA is failed
            logger.logf_P(LOG_ERR,PSTR("OTA failed"));
        break;
        case HomieEventType::OTA_SUCCESSFUL:
        // Do whatever you want when OTA is successful
            logger.logf_P(LOG_NOTICE,PSTR("OTA successful"));
        break;
        ...
        */
            logger.logf_P(LOG_ERR,PSTR("MQTT disconnected reason=%d"),event.mqttReason);
        break;
        ...
        // Do whatever you want when statistics are sent in normal mode
            logger.logf_P(LOG_DEBUG,PSTR("Sending stats"));
        break;
    }
}
